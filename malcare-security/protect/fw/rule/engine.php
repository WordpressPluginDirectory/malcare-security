...
if (!class_exists('MCProtectFWRuleEngine_V639')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V639 {
	use MCProtectFWRuleStringFunc_V639;
	use MCProtectFWRuleArrayFunc_V639;
	use MCProtectFWRuleMiscFunc_V639;
	use MCProtectFWRuleRequestFunc_V639;
	use MCProtectFWRuleWPFunc_V639;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V639::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V639 $e) {
			$this->error = $e;
		}
	}
